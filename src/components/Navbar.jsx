...
import { Gamepad2, Trophy, Users, Download, Newspaper, CalendarDays } from 'lucide-react';
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 border-b border-white/10 backdrop-blur-md bg-black/40">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <button onClick={() => navigateTo('download')} className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-emerald-400 px-4 py-2 text-sm font-semibold text-black shadow-[0_0_30px_rgba(56,189,248,0.35)] hover:brightness-110 active:scale-95 transition-all">
